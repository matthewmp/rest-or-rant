...
function () {
  ...
  _createClass(SectionManager, [{
    key: "addNewSection",
    value: function addNewSection(section) {
    ...
    key: "isSectionNameValid",
    value: function isSectionNameValid(sectionName) {
      var newSectionName = sectionName.trim();
    ...
    key: "clearAllSections",
    value: function clearAllSections() {
...
var _SectionMgr = _interopRequireDefault(require("./SectionMgr"));
...
function () {
  function Section(sectionName) {
    ...
    if (_SectionMgr.default.isSectionNameValid(name)) {
      this.sectionName = name;

      _SectionMgr.default.addNewSection(this);
    } else {
      throw new Error("Section Name: ".concat(name, " already in use"));
    }
  }

  _createClass(Section, [{
    key: "setServerName",
    value: function setServerName(name) {
      var newServerName = name.trim();
